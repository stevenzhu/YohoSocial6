    ...
    public void onClick(View v) {
      switch (v.getId()){
          ...
          case R.id.intoScannerTextView:
              EventBus1Activity.start(MainActivity.this,EventBus2Activity.class,null);
              break;
          case R.id.swipeToLayoutTextView:
              EventBus1Activity.start(MainActivity.this,SwipeToLoadActivity.class,null);
              break;
...
//              new ShareAction(MainActivity.this).withMedia(web).setPlatform(SINA.toSnsPlatform().mPlatform).setCallback(listener).share();
              ShareAction mShareAction= new ShareAction(MainActivity.this).setDisplayList(
...
//                       web.setThumb(image);
                                  new ShareAction(MainActivity.this).withMedia(web)
                                          ...
                                          .setCallback(new CustomShareListener(MainActivity.this))
                                          .share();
                          }
                      });
